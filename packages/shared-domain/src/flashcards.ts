...
/**
 * Human-readable labels for the 1–5 card-difficulty scale (the author/learner's
 ...
 * calibrated to the same meanings.
 */
...
/** Label for a difficulty value, clamped into 1–5. */
export function difficultyLabel(difficulty: number): string {
  const n = Math.min(5, Math.max(1, Math.round(difficulty))) as 1 | 2 | 3 | 4 | 5
  return DIFFICULTY_LABELS[n] ?? DIFFICULTY_LABELS[3]
}
